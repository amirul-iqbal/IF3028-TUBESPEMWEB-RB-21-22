    ...
    <div class="buat-laporan">
        <br>
        <a href="<?php echo site_url() . 'laporan/tambah/'; ?>" style="color:black"><b>Buat Laporan/Komentar </b><i class="fa fa-plus-square"></i></a>
    </div>
    <br>
    <div class="tampil-database">
        ...
        <?php $sort = array_reverse((array) $konten) ?>
        <?php foreach ($sort as $post) : ?>
            ...
            <div class="waktu-selengkapnya">
                Waktu: <?= $post['waktu']; ?>
                <a href="<?= base_url() . 'laporan/view/' . $post['id']; ?>"> Lihat Selengkapnya > </a>
            </div>
            <hr>
        <?php endforeach; ?>
    </div>
