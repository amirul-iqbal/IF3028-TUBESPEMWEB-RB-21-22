...
@section('container')
	<div class="container">
	  <form action="/laporansaya" method="POST" enctype="multipart/form-data" id="form">
	  	@csrf
	    ...
	    <div class="row">
	      ...
	      <div class="col-75">
	        <textarea id="isi_laporan" name="isi_laporan" placeholder="Write something.." style="height:200px" >{{ old('isi_laporan') }}</textarea>
	      </div>
	      @error('isi_laporan')
		    <div>
		      {{ $message }}
	...
	<script>
		...
		const form = document.getElementById('aspek_id'); 
